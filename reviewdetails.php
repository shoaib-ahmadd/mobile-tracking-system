...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td height="28"><span class="style1"></span></td>
     ...
     <td><span class="style1">Shop name</span></td>
    <td><span class="style1">Address</span></td>
    <td><span class="style1">Location</span></td>
    <td><span class="style1">Shop type</span></td>
...
//-->
  ...
  <tr bgcolor="#E4EDEC">
    ...
    <td bgcolor="#E4EDEC"><span class="style1"><?php echo $id; ?></span></td>
     <td bgcolor="#E4EDEC"><span class="style1"><a href="edit_auto_details1.php?id=<?php echo $id; ?>"><?php echo $product; ?></a></span></td>
    <td bgcolor="#E4EDEC"><span class="style1"><?php echo $address; ?></span></td>
    <td><span class="style1"><?php echo $location; ?></span></td>
    <td><span class="style1"><?php echo $shoptype; ?></span></td>
  
	
 <td><span class="style1"><!--<a href="edit_auto_details.php?id=<?php //echo $id; ?>">Edit</a>-->&nbsp;&nbsp;
     <a href="javascript:confirm_delete(<?php echo $id; ?>);">Delete</a></span></td>
    </tr>
  <?php
  }
  ?>
