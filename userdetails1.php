                  ...
                  <tr>
                    <td align="left" valign="top"><table width="756" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="left" valign="top" class="menu_bg">ll</td>
                  ...
                  <tr>
                    <td align="left" class="body_padding"><table width="736" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                              ...
                              <tr>
                                <td align="left" valign="top"><table width="180" border="0" cellspacing="0" cellpadding="0">
                                   ...
                                   <!-- <tr>
                                    ...
                                    <td align="left" valign="top" class="left_menu_bg"><a href="stockdetails.php" class="left_menu_link" > </a></td>
                                    </tr>
                                    
                                    
                                         
                                     <td align="left" valign="top" class="left_menu_bg"><a href="offerdetails.html" class="left_menu_link" ></a></td>
                                    </tr>
                                    <tr>
						  ...
						  <tr><td>TOWER</td><td><select name="tower">
	
	<?php include("connection.php");
		   	$q="select DISTINCT tower from log";
	$u=mysqli_query($q);
	while($s=mysqli_fetch_array($u))
	{
	?>
	<option>
	<!--<select name="tower">-->
	<?php echo $s["tower"]; ?></option>
	<?php 
	}
	?></select></td></tr>
	<tr>
