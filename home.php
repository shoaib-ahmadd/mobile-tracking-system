...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="756" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="120" align="left" valign="top"><a href="index.php" style="text-decoration:none"><img src="images/menu_right.gif" alt="" width="120" height="34" border="0" /></a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table></td>
    ...
    <td bgcolor="#F2E7E1"><span class="style1">id</span></td>
     <td><span class="style1">product id</span></td>
    ...
    <td><span class="style1">style</span>
	...
	<?php
	       include("connection.php");
						   $query="select * from ecommerce order by color desc";
						   $res=mysqli_query($conn, $query);						   while($res1=mysqli_fetch_array($res))
						   {
						   $id=$res1['id'];
  ...
  <tr bgcolor="#E4EDEC">
    ...
    <td bgcolor="#E4EDEC"><span class="style1"><?php echo $id?></span></td>
     <td><span class="style1"><?php echo $product; ?></span></td>
     <td><span class="style1"><?php echo $size; ?></span></td>
    <td><span class="style1"><?php echo $price; ?></span></td>
	<td><span class="style1"><?php echo $color; ?></span></td>
	<td><span class="style1"><?php echo $description; ?></span></td>
    <td><span class="style1"><?php echo $catagory; ?></span></td>
	<td><span class="style1"><?php echo $style; ?></span></td>
    <td><span class="style1"><?php echo $brand; ?></span></td>
    <td><span class="style1"><?php echo $count; ?></span></td>
	<td><span class="style1"><?php echo $image; ?></span></td>
   <!--td><span class="style1">
    <a href="delete.php?id=<?php echo $id; ?>">Delete</a></span></td>
    </tr-->
  <?php
  }
  ?>
