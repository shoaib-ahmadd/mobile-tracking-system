...
<title>Welcome to Music Review Admin</title>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" class="menu_bg"><table width="350" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td align="center" valign="middle"><a href="editadmin.php" class="menu_link" style="color:#FFFFFF;">Change password</a></td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="center" valign="middle">&nbsp;</td>
                                <td align="center" valign="middle">&nbsp;</td>
                              </tr>
                          </table></td>
                          <td width="120" align="left" valign="top"><img src="images/menu_right.gif" alt="" width="120" height="34" /></td>
                        </tr>
                    </table></td>
                  </tr>
                </table></td>
                  ...
                  <tr>
                    <td align="left" class="body_padding"><table width="736" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="180" align="left" valign="top"><table width="180" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" valign="top"><table width="180" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td align="left" valign="top" class="left_menu_bg"><a href="newvideos.php" class="left_menu_link style2 style6">New</a></td>
                                    </tr>
                                    <tr>
                          ...
                          <form name="deleteform" action="deletetask.php" method="post">
                          <table width="544" border="0" >
						  <tr bgcolor="#F2E7E1">
    <td height="28" align="center"><? $id=$_REQUEST['id'];
	 include("connection.php");
						   ...
						   ?>
                           <p class="style1"><span class="style5">Do you want to delete the user&nbsp;<? echo $id; ?></span></p>
                           <p class="style1"><br />
